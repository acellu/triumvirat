...
/* ------------------------ Update Axel ----------------------------------------- */
#define TFC_DIP_SWITCH0 			TFC_GetDIP_Switch()&0x01
#define TFC_DIP_SWITCH1 			TFC_GetDIP_Switch()&0x02
#define TFC_DIP_SWITCH2 			TFC_GetDIP_Switch()&0x04
#define TFC_DIP_SWITCH3 			TFC_GetDIP_Switch()&0x08
/* ------------------------------------------------------------------------------ */
