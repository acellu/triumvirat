...
double angle_integrator_factor = ANGLE_INTEGRATOR_FACTOR;
double angle_derivator_factor = ANGLE_DERIVATOR_FACTOR;
double angle_proportionnal_factor = ANGLE_PROPORTIONNAL_FACTOR;
